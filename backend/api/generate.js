...
async function getWorkingModel() {
  ...
  const usableModel = models.find(model =>
    model.supportedGenerationMethods &&
    model.supportedGenerationMethods.includes("generateContent")
  );

  if (!usableModel) {
    throw new Error("No compatible generateContent model found.");
  }

  // model.name comes like: "models/gemini-pro"
  const cleanName = usableModel.name.replace("models/", "");
